...
public enum MoveType {
    ...
    ABILITY(ROOT, "ability"),
        ...
        FOURTH_ABILITY(ABILITY, "fourth-ability"),
    ...
    public int getAbilityOrder() {
        return switch (this) {
            ...
            case FOURTH_ABILITY, FOURTH_SUPPORT_ABILITY -> 4;
            case FIFTH_SUPPORT_ABILITY -> 5;
            default -> throw new IllegalArgumentException("[MoveType.getOrder] Order is not defined for " + this);
        };
    }
}
