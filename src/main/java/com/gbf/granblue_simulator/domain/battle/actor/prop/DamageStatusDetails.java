...
import static com.gbf.granblue_simulator.domain.base.statuseffect.StatusModifierType.*;
import lombok.*;
...
public class DamageStatusDetails implements Cloneable {
    ...
    /* 베이스 */
    @Getter(AccessLevel.PROTECTED) private double baseAmplifyDamageRate;
    @Getter(AccessLevel.PROTECTED) private double baseAttackAmplifyDamageRate;
    @Getter(AccessLevel.PROTECTED) private double baseAbilityAmplifyDamageRate;
    @Getter(AccessLevel.PROTECTED) private double baseChargeAttackAmplifyDamageRate;

    @Getter(AccessLevel.PROTECTED) private double baseDamageCapUpRate;
    @Getter(AccessLevel.PROTECTED) private double baseAttackDamageCapUpRate;
    @Getter(AccessLevel.PROTECTED) private double baseAbilityDamageCapUpRate;
    @Getter(AccessLevel.PROTECTED) private double baseChargeAttackDamageCapUpRate;
